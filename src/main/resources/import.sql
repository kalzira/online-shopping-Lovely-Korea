...
INSERT INTO "public"."product_in_order" VALUES ('001',	0, '2019-05-27 21:31:56', 'Набор из миниаютюр очищающего крема Clean it Zero с текстурой сливочного щербета, эффективно очищающего загрязнения и стойкий макияж.', 'https://stylestory.com.au/wp-content/uploads/2018/09/Banila-Clean-It-Zero-Special-Kit-510x510.jpg', 'Очищающиe крема Banila Co. Clean it Zero', 430.00,	0,	7,'2019-05-26 18:18:13');
INSERT INTO "public"."product_in_order" VALUES ('002', 3, '2019-05-27 21:31:46', 'Данный высокоэффективный серум для лица содержит комплекс питательных веществ для эффективной борьбы с морщинами.',	'https://hollyshop.ru/upload/iblock/13f/13f675bc6e566a59761126ae6eaa77ed.jpg', 'Серум Mizon Original Skin Energy Peptide 500',	1190.00,	0,	2, '2019-05-27 21:31:46');
